    ...
    pub const FE310 = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const PLIC = struct {
                ...
                /// priority group: Interrupt Priority Register
                ...
                /// pending group: Interrupt Pending Register
                ...
                /// enable group: Interrupt Enable Register
            ...
            pub const PMU = struct {
                ...
                /// pmuwakepm group: PMU Wake Program Memory
                ...
                /// pmusleeppm group: PMU Sleep Program Memory
            ...
            pub const QSPI0 = struct {
                ...
                pub const fmt = @as(*volatile mmio.Mmio(packed struct(u32) {
                    ...
                    direction: enum(u1) {
                        ...
                        /// For dual and quad protocols, the DQ pins are tri-stated. Forthe single protocol, the DQ0 pin is driven with the transmitdata as normal.
                        Rx = 0,
